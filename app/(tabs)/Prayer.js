...
const Prayer = () => {
  const { getCategoryPrayer, prayerCategory, postPrayerRequest } =
    useAppContext();
  ...
  const transformedData = prayerCategory.map((item) => ({
    ...item,
  ...
  const submitPrayerRequest = () => {
    validateCredentials(formData, "Prayer Request");
        ...
        <View style={styles.formContainer}>
          ...
          <TouchableOpacity onPress={openModal}>
            <Input
              ...
              label="Select prayer request category"
          ...
          <View style={styles.switchContainer}>
            <Text>Make Prayer Request Anonymous</Text>
            <Switch
